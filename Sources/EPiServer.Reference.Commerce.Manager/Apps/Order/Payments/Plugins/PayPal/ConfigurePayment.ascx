...
<div id="DataForm"> 
    ...
    <table class="DataForm">
        ...
        <tr>
              <td class="FormLabelCell"><asp:Literal ID="Literal5" runat="server" Text="API Username" />:</td>
	          <td class="FormFieldCell">
		            <asp:TextBox Runat="server" ID="APIUser" Width="300px" MaxLength="250"></asp:TextBox><br/>
		            <asp:RequiredFieldValidator ControlToValidate="APIUser" Display="dynamic" Font-Name="verdana" Font-Size="9pt"
			                ErrorMessage="API Username required" runat="server" id="Requiredfieldvalidator4"></asp:RequiredFieldValidator>
	          </td>
        </tr>
	     <tr>
            <td colspan="2" class="FormSpacerCell"></td>
        ...
        <tr>
	          ...
	          <td class="FormFieldCell">
		            <asp:TextBox Runat="server" ID="Password" Width="300px" TextMode="Password" MaxLength="250"></asp:TextBox><br/>
